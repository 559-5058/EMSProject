...
<body>
    ...
    <div id="home" class="container">
        ...
        <form action = 'edit'>
            ...
            <input type="text" name="email" value = '<%=request.getParameter("email") %>' required s/>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
            		home: 'url(https://www.f6s.com/content-resource/media/5618718_eb617cba08d78f5bf70b7df8e833d5dea173458b.jpg)',
                    registration: 'url(https://img.freepik.com/free-vector/job-interview-conversation_74855-7565.jpg)',
                    login: 'url(https://www.placements.codegnan.com/images/banner-girl.webp)',
                    admin: 'url(https://nri.codegnan.com/images/sairam.webp)',
                    about: 'url(https://i.ytimg.com/vi/LvfpoJqiqdc/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLDoW8EL9j6VYH5-8-7f7XXmROhAMQ)',
                    contact: 'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkR73q2l9dsBX1bOpaZSbwaXMwqmVbWF6x3A&s)',
            };
